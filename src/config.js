...
module.exports = {
  ...
  DISCOVERY_SOURCE: str('DISCOVERY_SOURCE', 'dexscreener'), // dexscreener | onchain_stub
  MAX_PAIR_AGE_MIN: num('MAX_PAIR_AGE_MIN', 1000000), // ~2 года - ослаблен для тестирования
  MIN_PAIR_AGE_MIN: num('MIN_PAIR_AGE_MIN', 0),
  DEBUG_DISCOVERY: bool('DEBUG_DISCOVERY', false),

  // Фильтры - ослаблены для тестирования с текущими данными DexScreener
  MIN_LIQUIDITY_SOL: num('MIN_LIQUIDITY_SOL', 3),
  MAX_TAX_BPS: num('MAX_TAX_BPS', 1500),
  MIN_LIQUIDITY_USD: num('MIN_LIQUIDITY_USD', 100), // ослаблен
  MIN_VOLUME_H24_USD: num('MIN_VOLUME_H24_USD', 100), // ослаблен
  MIN_TXNS_M5: num('MIN_TXNS_M5', 0), // ослаблен
  MAX_FDV_USD: num('MAX_FDV_USD', 1000000000), // увеличен

  // Dexscreener search query (официальный search-роут)
